...
本系统是1998年阿色带领团队基于B/S模式开发的软件产品，是为加强团队协作而建立的任务管理系统，曾大规模应用于阿色供职的超大企业和其下属企业，以及外部用户单位。
...
这是阿色2009年用VB写的一个在触目屏电视上手写留言的小程序。也可以用鼠标写。
...
☆ 说明：上述代码均为阿色和有关人员业余时间所写的个人成果，与单位相关的代码也已经过期作废处理并已脱密公开，不涉及任何版权问题。若对阿色及团队的本职工作成果感兴趣，请联系本人或本人单位按对公业务处理。
