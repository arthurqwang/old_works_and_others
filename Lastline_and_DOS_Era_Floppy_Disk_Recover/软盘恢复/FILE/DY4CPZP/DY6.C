...
void mkmn()
  {
   ...
   puthzxy("← → : 选择   ←┘:确认",410,14,CCLIB,YELLOW,CYAN,0);
   setcolor(RED);
   ...
   puthzxy(" Ctrl-b:放大     Ctrl-s:缩小    Pgup/Pgdn:翻页",50,454,CCLIB,YELLOW,CYAN,0);
   ...
   while(key!=283)
    {
	 ...
	 case 12290:
	     ...
	     high(240,13,410,31);
	     puthzxy("窗  口  编  辑",270,15,CCLIB,RED,CYAN,0);
	     draw_box(10,450,630,475);
	     puthzxy("Esc/Ctrl-b:关闭      1-9:移动步长      ← → :移动      ←┘:放大 ",50,454,CCLIB,YELLOW,CYAN,0);
	     win(185,167,455,343);
