...
void title(void)
  {
    WINGRA *win;
    unsigned char hdd[30]={0xde,0xde,0x31,0x09,0xde,0xde,0x36,0x56,0xde,0xde,0xde,0xde,0xde,0xde,0xde,
		     0xde,0xde,0xd6,0xcd,0xc5,0xc5,0xcb,0xd5,0xfe};
    int graphdrive=DETECT,mode,i;
/*    int graphdrive=EGA,mode=EGAHI,i;*/
    CCLIB=open("\\lastline\\lsth.inf",O_RDONLY|O_BINARY);
