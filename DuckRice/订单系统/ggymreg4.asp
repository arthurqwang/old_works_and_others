...
<form name='or1' method='post' action='http://www.kxqbz.com/guaguayami/order3.asp'>

<input type='hidden' name='dlwm_tem' value='<% response.write request("dlwm_tem") %>'>
<input type='hidden' name='ndxm_tem' value='<% response.write request("ndxm_tem") %>'>
<input type='hidden' name='cysj_tem' value='<% response.write request("cysj_tem") %>'>



　　登录网名:<% response.write request("dlwm_tem") %><br>
　　您的姓名:<% response.write request("ndxm_tem") %><br>
